  ...
  return (
    <div>
      <div className='flex gap-6 mb-8'>
        ...
        min-[320px]:w-2/4'>
          <h2 className='text-2xl font-bold mb-4 min-[320px]:text-xs'>
            Bienvenido al club de lectura del libro {nombreDelLibroAsociado}
          </h2>
          <p className='mb-4 min-[320px]:text-xs'>
        ...
        min-[320px]:w-2/4'>
          <h2 className='text-xl font-bold mb-4 min-[320px]:text-xs'>Comentarios</h2>

          {comments.filter(comment => comment.comment !== '').length === 0 ? (
            <p className='mb-4 text-gray-600 min-[320px]:text-xs'>No hay comentarios.</p>
          ) : (
            comments.map(
              (comment, index) =>
                comment.comment !== '' && (
          ...
          />
          <button
            className='mt-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-700 min-[320px]:text-xs'
